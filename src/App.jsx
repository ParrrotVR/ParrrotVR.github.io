    ...
    <ClickSpark>
      ...
      <header className="nav-wrap">
        ...
        <nav aria-label="Main navigation">
          ...
          <a className="prototype-nav-link cursor-target" data-cursor-label="SWITCH" href="/prototype/">P02</a>
          <a className="prototype-nav-link cursor-target" data-cursor-label="SWITCH" href="/monochrome/">P03</a>
